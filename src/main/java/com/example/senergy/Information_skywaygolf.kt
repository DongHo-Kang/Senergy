...
import kotlinx.android.synthetic.main.activity_information_skywaygolf.btn_add_icon as btn_add_icon1
import kotlinx.android.synthetic.main.activity_information_skywaygolf.btn_bell_icon1 as btn_bell_icon1
import kotlinx.android.synthetic.main.activity_information_skywaygolf.btn_chat_icon as btn_chat_icon1
import kotlinx.android.synthetic.main.activity_information_skywaygolf.btn_reminder as btn_reminder1
import kotlinx.android.synthetic.main.activity_information_skywaygolf.btn_user_icon as btn_user_icon1
...
class Information_skywaygolf : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_information_skywaygolf)

        btn_back.setOnClickListener {

            val intent = Intent(this, Dynamic::class.java) //btn_back 누르면 Dynamic로 넘어감
        ...
        btn_booking.setOnClickListener {
            val intent = Intent(this, Planner1::class.java) // booking 누르면 Planner로 넘어감
            startActivity(intent)
        ...
        btn_heart_icon1.setOnClickListener{

            val intent = Intent(this, Wishlist::class.java)
            startActivity(intent)
        }
        btn_wishlist1.setOnClickListener{

            val intent = Intent(this, Wishlist::class.java)
            startActivity(intent)
        }
        btn_bell_icon1.setOnClickListener{
